...
public class Population extends Configured implements Tool {
	...
	public int run(String[] arg0) throws Exception {
		...
		// Create a new RandomSampler for this particular MapReduce job that
		// uses a 10% chance of a key to be choosen and find 200 samples from 3
		// input splits
		...
		java.net.URI partitionUri = new java.net.URI(partitionFile + "#"
